...
function LoginForm() {
  ...
  return (
    <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-[0_8px_30px_rgb(0,0,0,0.02)] border border-slate-100/80 w-full max-w-[400px] mt-6 space-y-5">
      ...
      {justRegistered && (
        <div className="flex items-center gap-3 p-3.5 rounded-xl bg-green-50 border border-green-100 text-green-700 text-xs">
      ...
      {state?.error && (
        <div className="flex items-center gap-3 p-3.5 rounded-xl bg-red-50 border border-red-100 text-red-700 text-xs">
      ...
      <form action={formAction} className="space-y-4">
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative flex items-center">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 bg-slate-50/50 hover:bg-slate-50 border border-slate-200/60 focus:border-slate-300 focus:bg-white rounded-xl text-sm text-slate-800 placeholder-slate-400/80 focus:outline-none transition-all duration-200"
            />
          </div>
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative flex items-center">
            ...
            <input
              ...
              required
              placeholder="••••••••"
              className="w-full pl-12 pr-12 py-3 bg-slate-50/50 hover:bg-slate-50 border border-slate-200/60 focus:border-slate-300 focus:bg-white rounded-xl text-sm text-slate-800 placeholder-slate-400/80 focus:outline-none transition-all duration-200"
            />
            <button
              type="button"
        ...
        <div className="flex items-center gap-2.5 pt-1">
          <input
            ...
            id="keep-signed-in"
            name="keep_signed_in"
            className="w-4.5 h-4.5 rounded border-slate-300 text-[#0B1A2E] focus:ring-[#0B1A2E] bg-white cursor-pointer"
          />
          <label
      ...
      <div className="grid grid-cols-2 gap-3">
        <button
          type="button"
          disabled
          className="flex items-center justify-center gap-2 py-2.5 px-4 bg-white border border-slate-200 rounded-xl text-xs font-semibold text-slate-400 shadow-sm transition-all cursor-not-allowed opacity-60"
        >
        ...
        <button
          type="button"
          disabled
          className="flex items-center justify-center gap-2 py-2.5 px-4 bg-[#24292F] rounded-xl text-xs font-semibold text-white/50 shadow-sm transition-all cursor-not-allowed opacity-60"
        >
